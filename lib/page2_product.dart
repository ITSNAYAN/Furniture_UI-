...
class product extends StatefulWidget {
  ...
  const product(
   {super.key, required this.image1, required this.name1, required this.price1, required this.Description1,});
 ...
 final List<String> imageUrls = <String>[
      'https://t3.ftcdn.net/jpg/02/71/05/60/360_F_271056073_C0tbpNLFbcGurqxoMXqPBrx8vzL9VLVY.jpg', // Grey
      'https://image.made-in-china.com/2f0j00mOhVjWECLFpU/Nordic-Style-Modern-Upholstered-Shell-Velvet-Red-Armchair-Modern-Design-Living-Room-Sofa-Chair.webp',//red
      'https://www.massimogardone.it/www/wp-content/uploads/2020/07/Knit_513_01-768x1024.jpg', //black
  ];
